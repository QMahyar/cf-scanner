...
/// bare date is rejected with "Invalid registration request").
fn tos_timestamp() -> String {
    let utc = crate::ranges::rfc3339_utc(crate::ranges::unix_now());
    format!("{}.00+00:00", utc.strip_suffix('Z').unwrap_or(&utc))
}
